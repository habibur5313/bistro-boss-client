...
const Regsiter = () => {
                    const {SignUpEmailAndPassword,Update_information,SignInGoogle} = useAuth()
        ...
        <div className="card bg-base-100 mt-10 w-1/2 mx-auto shrink-0 shadow-2xl">
          <form className="card-body" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="form-control">
              ...
              {errors.password?.type === "minLength" && <span className="text-red-600">min 6 charcters</span>}
              {errors.password?.type === "maxLength" && <span className="text-red-600">max 20 charcters</span>}
              {errors.password?.type === "pattern" && <span className="text-red-600">Minimum eight characters, at least one uppercase letter, one lowercase letter and one number</span>}
